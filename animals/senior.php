...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_array(MYSQLI_ASSOC)) {
        $tbody .= "<tr>
            <td><img class='img-thumbnail rounded-circle' src='pictures/" . $row['pic_animal'] . "' alt=" . $row['pic_animal'] . "></td>
            <td>" . $row['name']."</td>
            <td>" . $row['location'] . "</td>
            <td>" . $row['age'] . "</td>
            <td>" . $row['breed'] . "</td>
           <td> <a  href='../info.php?id=" . $row['id'] . "&previouse_page=seniour'><button class='btn btn-info btn-sm' type='button'>show</button></a></td>
         </tr>";
    }
} else {
...
<div class="container mt-5">
    <div class="row">
        ...
        <p class="">user</p>
        <a href="index.php">All animals</a>
        <br/>
        <a href="../logout.php?logout">Sign Out</a>
        </div>

        <div class="col-8 mt-2">
        <p class='h2'>Senior Animals</p>
